...
fx misassembly_qq misassembly_qq.fa \
   ...
   'type=incomplete;anom=fragmented_q;gran=Q;telo=1;labels=q;gaps=0;telolen=900' \
...
fx gapped_misassembly gapped_misassembly.fa \
   ...
   'type=incomplete;anom=fragmented_p;gran=P;telo=1;labels=p;gaps=1;telolen=900' \
...
fx boundary_multiple_p boundary_multiple_p.fa \
   ...
   'type=incomplete;anom=.;gran=P;telo=1;labels=p;gaps=0;telolen=600' \
...
fx gapped_misassembly_qq gapped_misassembly_qq.fa \
   ...
   'type=incomplete;anom=fragmented_q;gran=Q;telo=1;labels=q;gaps=1;telolen=900' \
